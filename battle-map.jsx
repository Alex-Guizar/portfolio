// Battle map — isometric tile renderer + map composition + decor sprites.
// Depends on fft-chrome.jsx (stFt palette, FFTPanel, FFTMenuItem, FFTCharacter).

const { stFt, FFTPanel, FFTMenuItem, FFTCharacter } = window;

// ─── Iso tile primitives ────────────────────────────────────────────────────
// Tile is 64×32 displayed; SVG viewBox is 32×16 native pixels (scale 2×).
// Depth (sides) is 12 displayed / 6 native.
...
Object.assign(window, { BattleMap, IsoTile, PixelTree, PixelCrystal, PixelLamp, PixelChest });
