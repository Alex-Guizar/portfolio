// Project detail page — opens at #/project/<id>.
// Depends on fft-chrome.jsx for stFt + panel/menu primitives.

const { stFt: stP, FFTPanel: FP, FFTMenuItem: FMI, btnStyle: bs, fftButtonStyle: ffbs, UtilityBar: UB, SectionPlain: SP } = window;

// ─── Screenshot placeholder ─────────────────────────────────────────────────
// 16:9 box, FFT-styled. Drop a real <img> in instead when you have one.
...
// ─── Stat tile (for the stat strip below the hero) ──────────────────────────
...
// ─── Metric callout (large number, small label) ─────────────────────────────
...
// ─── Major content section inside the FFT chrome ────────────────────────────
...
function ProjectDetail({ project, onTogglePlain, plain, onBack }) {
